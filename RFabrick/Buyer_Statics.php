...
<table width="1000" border="0" align="center">
  <tr>
    <td height="10px"><font color="#848484"  size="2" face="Segoe UI"><i>You are in Here : Buyer Statistics</i></font></td>
  </tr>
</table>
<table width="1000" border="0" align="center" bgcolor="#FFFFFF">
<tr>
  <td height="39" colspan="3"><font color="#6E6E6E" face="Segoe UI" size="+2">Orders</font></td>
  </tr>
  <tr>
  ...
  <tr>
  <td width="243" height="30" bgcolor="#5882f"><input type="button" style="border-style:hidden;height:100%;background:#5882fa;width:100%;height:25px;color:#FFF"" onclick="location.href = 'Supplier_Profile.html'" value="Edit Profile" text="Supplier Profile" /></td>
  <td width="243" height="30" bgcolor="#5882f"><input type="button" style="border-style:hidden;height:100%;background:#5882fa;width:100%;height:25px;color:#FFF"" onclick="location.href = 'Supplier_Profile.html'" value="Deactivate Profile" text="Supplier Profile" /></td>
  </tr>
  <tr>
    <td colspan="3" bgcolor="#FFFFFF"><font color="#6E6E6E" face="Segoe UI">Orders Summary</font></td>
  </tr>
  <tr>
    <td height="320" colspan="3" bgcolor="#F2F2F2"></td>
  </tr>
</table>
<table width="1000" border="0" align="center">
  <tr>
