...
<table width="420px" bgcolor="#FFFFFF" height="300px" class="tblea"  border="0" align="center">
  ...
  <tr>
    ...
    <tr>
    <td colspan="3" bgcolor="#fafafa" align="justify"><div><font color="#848484" size="3" face="Segoe UI">After you click 'Approve' button, All the deny item details regarding item will be approved. 
      Details like price, qty &amp; etc. of item no longer hidden.</font></div></td>
...
$FabricsID = $_GET["title"];
				...
				//Update Supplier Table
					...
					$sql ="
					UPDATE `rfabricsdatabase`.`fabrics` SET `Status` = 'Yes' WHERE `fabrics`.`FabricID` = '".$FabricsID."';";
				...
				//Insert in to Systemlog Table
					...
					VALUES (
					NULL ,
					CURRENT_TIMESTAMP , 'Approve Fabric Stock by Stock-keeper'
					);
					";			
