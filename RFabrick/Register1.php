...
function validate2()
{
	if(validateBrandName2() && validateDescription2() && validateFirstName2() && validateLastName2() && validateAddress2() && validateTelephone2() && validateeMail2() && validatePassword2() && validateConfirmPassword2() && confirmPassword2())
	{
		var xamlhttp = new XMLHttpRequest();
		xamlhttp.open("GET",
