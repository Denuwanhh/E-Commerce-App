...
<table width="420px" bgcolor="#FFFFFF" height="300px" class="tblea"  border="0" align="center">
  ...
  <tr>
    ...
    <tr>
    <td colspan="3" bgcolor="#fafafa" align="justify"><div><font color="#848484" size="3" face="Segoe UI">After you click 'Permit' button, All the suspanded actions regarding user will be permit. 
      Actvities like purchasing ,suppling no longer suspanded.</font></div></td>
...
$userID = $_GET["title"];
				...
				//Update Supplier Table
					...
					$sql ="
					UPDATE `suppliers` SET `Ratings`= 0 WHERE UserID = '".$userID."';";
				...
				//Insert in to Systemlog Table
					...
					VALUES (
					NULL ,
					CURRENT_TIMESTAMP , 'Permit Supplier Account by Administrator'
					);
					";			
