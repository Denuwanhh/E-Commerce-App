...
<table width="420px" bgcolor="#FFFFFF" height="300px" class="tblea"  border="0" align="center">
  <tr>
    ...
    <form id="form1" name="form1" method="Get" action="Stock-keeper_Dashboard.php">
  <tr>
  ...
  <tr>
    ...
    <tr>
    <td colspan="3" bgcolor="#fafafa" align="justify"><div><font color="#848484" size="3" face="Segoe UI">After you click 'Suspand' button, All the approved item details regarding item will be hidden. 
      Details like price, qty &amp; etc. of item no longer visible.</font></div></td>
...
$FabricsID = $_GET["title"];
				...
				//Update Supplier Table
					...
					$sql ="
					UPDATE `rfabricsdatabase`.`fabrics` SET `Status` = 'No' WHERE `fabrics`.`FabricID` = '".$FabricsID."';";
				...
				//Insert in to Systemlog Table
					...
					VALUES (
					NULL ,
					CURRENT_TIMESTAMP , 'Suspand Fabric Stock by Stock-keeper'
					);
					";			
